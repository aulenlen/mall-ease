...
public class SpuDetailTargetUriBuilder {
    ...
    private static final String PRODUCT_DETAIL_PATH = "/portal/products/{spuId}";
    private static final String PRODUCT_FLASH_DETAIL_PATH = "/portal/products/flash/{spuId}";
