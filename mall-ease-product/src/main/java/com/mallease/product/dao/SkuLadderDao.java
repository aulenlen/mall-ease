...
public interface SkuLadderDao {
     ...
     */
    List<SkuLadder> selectBySkuId(@Param("skuId") Long skuId);
     ...
     * @return 阶梯价格列表
     */
    List<SkuLadder> selectBySkuIds(@Param("skuIds") List<Long> skuIds);
     ...
     */
    SkuLadder selectBestLadder(@Param("skuId") Long skuId, @Param("count") Integer count);
     ...
     * @return 影响行数
     */
    int insertBatch(@Param("list") List<SkuLadder> list);
