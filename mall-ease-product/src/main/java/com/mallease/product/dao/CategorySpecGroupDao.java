 ...
 */
@Mapper
public interface CategorySpecGroupDao {
     ...
     * @return 关联列表
     */
    List<CategorySpecGroup> selectByCategoryId(@Param("categoryId") Long categoryId);
     ...
     * @return 关联列表
     */
    List<CategorySpecGroup> selectBySpecGroupId(@Param("specGroupId") Long specGroupId);
     ...
     */
    CategorySpecGroup selectByCategoryIdAndSpecGroupId(@Param("categoryId") Long categoryId,
     ...
     * @return 影响行数
     */
    int insert(CategorySpecGroup record);
     ...
     * @return 影响行数
     */
    int insertBatch(@Param("list") List<CategorySpecGroup> list);
