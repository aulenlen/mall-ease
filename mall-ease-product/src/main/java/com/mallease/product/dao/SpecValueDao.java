...
public interface SpecValueDao {
     ...
     * @return 规格值列表
     */
    List<SpecValue> selectByIds(@Param("ids") List<Long> ids);
     ...
     * @return 规格值列表
     */
    List<SpecValue> selectBySpecIds(@Param("specIds") List<Long> specIds);
     ...
     * @return 规格值记录
     */
    SpecValue selectBySpecIdAndValue(@Param("specId") Long specId, @Param("value") String value);
     ...
     * @return 影响行数
     */
    int insertBatch(@Param("list") List<SpecValue> list);
