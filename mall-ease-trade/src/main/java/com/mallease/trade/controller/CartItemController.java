...
public class CartItemController {
    ...
    public R<CartPageVO> portalList(
    ...
    public R<CartSummaryVO> updateQuantity(@Validated(CartItemCmd.Update.class) @RequestBody CartItemCmd cmd) {
    ...
    public R<CartSummaryVO> updateChecked(@Validated @RequestBody CartCheckedCmd cmd) {
        Long userId = LoginContextUtil.getUserId();
    ...
    public R<CartSummaryVO> updateCheckedAll(
