...
public interface CmsPreferenceAreaService {
     ...
     * @return 创建记录数
     */
    int create(CmsPreferenceArea prefrenceArea);
     ...
     * @return 更新记录数
     */
    int update(Long id, CmsPreferenceArea prefrenceArea);
     ...
     * @return 优选专区信息
     */
    CmsPreferenceArea getById(Long id);
     ...
     * @return 优选专区列表
     */
    List<CmsPreferenceArea> listByName(String name);
     ...
     * @return 优选专区列表
     */
    List<CmsPreferenceArea> listByShowStatus(Integer showStatus);
