...
public interface PmsSkuDao {
     ...
     * @return SKU列表
     */
    List<PmsSku> selectByIds(@Param("ids") List<Long> ids);
     ...
     * @return SKU记录
     */
    PmsSku selectBySkuCode(@Param("skuCode") String skuCode);
     ...
     * @return SKU列表
     */
    List<PmsSku> selectBySpuIds(@Param("spuIds") List<Long> spuIds);
     ...
     * @return SKU列表
     */
    List<PmsSku> selectByConditions(@Param("spuId") Long spuId,
     ...
     * @return 影响行数
     */
    int insertBatch(@Param("list") List<PmsSku> list);
