...
import com.mallease.app.feign.ContentFeignClient;
import com.mallease.app.feign.MarketingFeignClient;
import com.mallease.app.feign.ProductFeignClient;
import com.mallease.app.feign.SearchFeignClient;
import com.mallease.app.model.vo.HomePageVO;
 ...
 * @create: 2026-01-08
 */
@Tag(name = "App首页", description = "首页聚合数据接口")
@RestController
