 ...
 */
@Mapper
public interface PreferenceAreaDao {
    /**
     * 根据主键删除
     *
     * @param id 主键ID
     ...
     * @return 优选专区列表
     */
    List<PreferenceArea> selectByName(@Param("name") String name);
     ...
     * @return 优选专区列表
     */
    List<PreferenceArea> selectByShowStatus(@Param("showStatus") Integer showStatus);
