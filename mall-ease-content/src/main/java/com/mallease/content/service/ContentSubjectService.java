...
public interface ContentSubjectService {
     ...
     * @return 影响行数
     */
    int create(ContentSubject subject);
     ...
     * @return 影响行数
     */
    int update(Long id, ContentSubject subject);
     ...
     * @return 专题信息
     */
    ContentSubject getById(Long id);
     ...
     * @return 专题列表
     */
    List<ContentSubject> listByKeyword(String keyword);
     ...
     * @return 专题列表
     */
    List<ContentSubject> listByCategoryId(Long categoryId);
     ...
     * @return 推荐专题列表
     */
    List<ContentSubject> listRecommend();
     ...
     * @return 添加的记录数
     */
    int batchAddSpuRelation(List<ContentSubjectSpuRelation> relationList);
     ...
     * @return 关联列表
     */
    List<ContentSubjectSpuRelation> getRelationsBySpuId(Long spuId);
