...
import com.mallease.content.converter.ContentPreferenceAreaConverter;
...
public class ContentPreferenceAreaController {

    @Autowired
    private ContentPreferenceAreaService preferenceAreaService;

    @Autowired
    private ContentPreferenceAreaConverter preferenceAreaConverter;
    ...
    @PostMapping("/create")
    public R<Integer> create(@Validated @RequestBody CreateContentPreferenceAreaCmd cmd) {
        ContentPreferenceArea prefrenceArea = preferenceAreaConverter.createCmdToEntity(cmd);
    ...
    public R<Integer> update(@PathVariable Long id, @Validated @RequestBody UpdateContentPreferenceAreaCmd cmd) {
        cmd.setId(id);
        ContentPreferenceArea prefrenceArea = preferenceAreaService.getById(id);
    ...
    @GetMapping("/{id}")
    public R<ContentPreferenceAreaDetailVO> getById(@Parameter(description = "优选专区ID") @PathVariable Long id) {
        ContentPreferenceArea prefrenceArea = preferenceAreaService.getById(id);
        ContentPreferenceAreaDetailVO vo = preferenceAreaConverter.entityToDetailVo(prefrenceArea);
        return R.success(vo);
    }
    ...
    @GetMapping("/listAll")
    public R<List<ContentPreferenceAreaVO>> listAll() {
        List<ContentPreferenceArea> list = preferenceAreaService.listAll();
        List<ContentPreferenceAreaVO> voList = preferenceAreaConverter.entityListToVoList(list);
    ...
    @GetMapping("/list")
    public R<Page<ContentPreferenceAreaListVO>> list(
        ...
        List<ContentPreferenceArea> list;

        list = preferenceAreaService.listByName(name.trim());

        // 使用PageUtils转换分页结果
        Page<ContentPreferenceAreaListVO> result = PageUtils.convertPage(list, preferenceAreaConverter::entityListToListVoList);
    ...
    public R<Page<ContentPreferenceAreaListVO>> listByShowStatus(
        ...
        PageHelper.startPage(pageNum, pageSize);
        List<ContentPreferenceArea> list = preferenceAreaService.listByShowStatus(showStatus);
    ...
    public R<Integer> batchAddSpuRelation(@RequestBody List<ContentPreferenceAreaSpuRelation> relationList) {
    ...
    public R<List<ContentPreferenceAreaSpuRelation>> getRelationsBySpuId(
            @Parameter(description = "商品ID") @PathVariable("spuId") Long spuId) {
        List<ContentPreferenceAreaSpuRelation> list = preferenceAreaService.getRelationsBySpuId(spuId);
